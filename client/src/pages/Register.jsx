...
const Register = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] grid grid-cols-1 lg:grid-cols-2 bg-gray-50">
        ...
        <div className="mx-auto w-full max-w-sm lg:w-96 space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Join us to start your reading journey today.
            </p>
          </div>
      ...
      <div className="hidden lg:flex relative bg-primary-900 overflow-hidden order-1 lg:order-2">
        <div className="absolute inset-0 bg-gradient-to-bl from-secondary-700 to-primary-600 opacity-90"></div>
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1512820790803-83ca734da794?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center mix-blend-overlay"></div>
        <div className="relative w-full h-full flex flex-col justify-center items-center text-white px-12 text-center">
          <h2 className="text-4xl font-bold mb-6">Join Our Reader's Club</h2>
          <p className="text-lg text-primary-100 max-w-lg">
            Create an account to track your orders, save your wishlist, and get
